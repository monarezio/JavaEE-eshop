...
<head>
    <title>Shop</title>
    <link href="${pageContext.request.contextPath}/assets/dist/bundle.css" rel="stylesheet" type="text/css">
    <script src="${pageContext.request.contextPath}/assets/dist/bundle.js" type="text/javascript"></script>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
                <li class="nav-item mr-2">
                    <a class="nav-link" href="./user/session/login">Login</a>
                </li>
                <li>
                    <a class="btn btn-primary" href="./user/session/register">Register</a>
                </li>
            </ul>
        </div>
    </nav>
